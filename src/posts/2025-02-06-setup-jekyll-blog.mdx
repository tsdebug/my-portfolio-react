...
![GitHub + Jekyll](./blog-assets/GitHub+Jekyll.png)
...
![Create new repo](./blog-assets/create-new-repo.png)
...
![Enable GitHub Pages](./blog-assets/set-github-pages.png)
...
![Files For Setup](./blog-assets/files-for-blog.png)
